...
describe('useDiagramInteractions edge drag commit (browser mode)', () => {
  ...
  it('commits edge points on drag end', () => {
    ...
    act(() => {
      button?.dispatchEvent(new PointerEvent('pointerdown', { bubbles: true, button: 0, clientX: 220, clientY: 140, pointerId: 9 }));
      window.dispatchEvent(new PointerEvent('pointermove', { bubbles: true, buttons: 1, clientX: 220, clientY: 180, pointerId: 9 }));
      window.dispatchEvent(new PointerEvent('pointerup', { bubbles: true, button: 0, clientX: 220, clientY: 180, pointerId: 9 }));
    });
