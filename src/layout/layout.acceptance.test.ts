...
describe("layout acceptance: minimal A -> B -> C", () => {
  ...
  it("lays out 11 nodes across lane-0, lane-1, lane-2", () => {
    ...
    expect(result.result.nodes).toEqual([
      ...
      { id: "command-1", x: 670, y: 182, width: 120, height: 130 },
      { id: "event-1", x: 0, y: 182, width: 120, height: 50 },
      { id: "event-2", x: 160, y: 182, width: 120, height: 48 },
      { id: "event-3", x: 760, y: 404, width: 120, height: 48 },
      { id: "event-4", x: 920, y: 404, width: 120, height: 48 },
      { id: "node-1", x: 1080, y: 404, width: 120, height: 48 },
      { id: "node-2", x: 320, y: 182, width: 120, height: 48 },
      { id: "node-3", x: 510, y: 182, width: 120, height: 48 },
      { id: "node-4", x: 800, y: 0, width: 120, height: 48 },
      { id: "node-5", x: 1210, y: 182, width: 120, height: 48 },
    ]);
    expect(result.result.edges).toEqual([
      {
        id: "edge-1",
      ...
      },
      {
        ...
        targetAnchor: { x: 420, y: 40, side: "left", ordinal: 2 },
        points: [
          { x: 70, y: 182 },
          { x: 70, y: 162 },
          { x: 70, y: 40 },
      ...
      },
      {
        ...
        targetAnchor: { x: 420, y: 50, side: "left", ordinal: 0 },
        points: [
          { x: 230, y: 182 },
          { x: 230, y: 162 },
          { x: 230, y: 50 },
      ...
      },
      {
        ...
        sourceId: "command-1",
        targetId: "event-3",
        sourceAnchor: { x: 740, y: 312, side: "bottom", ordinal: 0 },
      ...
      },
      {
        ...
        sourceId: "command-1",
        targetId: "event-4",
        sourceAnchor: { x: 750, y: 312, side: "bottom", ordinal: 1 },
      ...
      },
      {
        ...
        sourceId: "command-1",
        targetId: "node-1",
        sourceAnchor: { x: 760, y: 312, side: "bottom", ordinal: 2 },
        targetAnchor: { x: 1130, y: 404, side: "top", ordinal: 0 },
        points: [
          { x: 760, y: 312 },
          { x: 760, y: 332 },
          { x: 1130, y: 332 },
      ...
      },
      {
        ...
        targetAnchor: { x: 420, y: 60, side: "left", ordinal: 1 },
        points: [
          { x: 390, y: 182 },
          { x: 390, y: 162 },
          { x: 390, y: 60 },
      ...
      },
      {
        ...
        sourceId: "command-1",
        targetId: "node-4",
        sourceAnchor: { x: 740, y: 182, side: "top", ordinal: 0 },
        targetAnchor: { x: 800, y: 19, side: "left", ordinal: 0 },
        points: [
          { x: 740, y: 182 },
          { x: 740, y: 162 },
          { x: 740, y: 19 },
      ...
      },
      {
        ...
        targetAnchor: { x: 1210, y: 201, side: "left", ordinal: 0 },
        points: [
          { x: 990, y: 404 },
          { x: 990, y: 384 },
          { x: 990, y: 201 },
      ...
      },
      {
        ...
        sourceId: "node-1",
        targetId: "node-5",
        sourceAnchor: { x: 1150, y: 404, side: "top", ordinal: 0 },
        targetAnchor: { x: 1210, y: 211, side: "left", ordinal: 1 },
        points: [
          { x: 1150, y: 404 },
          { x: 1150, y: 384 },
          { x: 1150, y: 211 },
...
describe("down arrow collision avoidance", () => {
  ...
  it("avoid edge crossings by reordering nodes", () => {
    const request: LayoutRequest = {
      nodes: [
        { id: "node-1", laneId: "lane-1" },
        { id: "node-2", laneId: "lane-0" },
        { id: "node-3", laneId: "lane-0" },
        { id: "node-4", laneId: "lane-1" },
      ],
      edges: [
        { id: "edge-1", sourceId: "node-1", targetId: "node-2" },
        { id: "edge-2", sourceId: "node-3", targetId: "node-4" },
        { id: "edge-3", sourceId: "node-2", targetId: "node-4" },
      ],
      lanes: [
        { id: "lane-0", order: 0 },
      ...
      defaults: { nodeWidth: 120, nodeHeight: 50 },
      spacing: { minTargetShift: 20, minNodeGap: 40 },
    };
    ...
    expect(result.result.nodes).toEqual([
      { id: "node-1", x: 0, y: 142, width: 120, height: 50 },
      { id: "node-2", x: 100, y: 0, width: 120, height: 50 },
      { id: "node-3", x: 260, y: 0, width: 120, height: 50 },
      { id: "node-4", x: 360, y: 142, width: 120, height: 50 },
    ]);
    expect(result.result.edges).toEqual([
      {
        id: "edge-1",
      ...
      },
      {
        ...
        targetId: "node-4",
        sourceAnchor: { x: 330, y: 50, side: "bottom", ordinal: 0 },
        targetAnchor: { x: 420, y: 142, side: "top", ordinal: 1 },
        points: [
          { x: 330, y: 50 },
          { x: 330, y: 70 },
          { x: 420, y: 70 },
      ...
      },
      {
        ...
        sourceId: "node-2",
        targetId: "node-4",
        sourceAnchor: { x: 170, y: 50, side: "bottom", ordinal: 0 },
        targetAnchor: { x: 410, y: 142, side: "top", ordinal: 0 },
        points: [
          { x: 170, y: 50 },
          { x: 170, y: 80 },
          { x: 410, y: 80 },
