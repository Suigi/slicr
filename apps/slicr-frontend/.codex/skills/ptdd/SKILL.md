...
- If a workflow phase is also active, prefix responses with both starter characters in this order: phase first, then `1️⃣`.
- Example combined prefix: `⚙️1️⃣ `
- If this skill is active without a workflow phase, use `1️⃣ `.
